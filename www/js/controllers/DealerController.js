surveyApp.controller('DealerController', function ($rootScope, $scope, $stateParams, $http, AuthService, DealerService,
    AUTH_EVENTS, NETWORK, Dealers, $state, SurveyService, $localstorage, STORAGE_KEYS, DealerMap) {
    ...
    $scope.dealerDetail = function (dealerId, surveyId) {
        console.log("CHANGE VIEW")
        DealerService.setCurrentDealerId(dealerId);
        $state.go("tabs.dealer-detail", {SurveyId: surveyId});
    }
})